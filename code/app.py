...
def Vytvor_profil(jmeno,prijmeni,prezdivka,email,telefon,heslo,vek,orientace,konicky,popis):
    ...
    Add_profile_neo(node_id,jmeno,prijmeni,prezdivka,telefon,email,hash_pass,vek,orientace,konicky,popis) #vytvorim profil v grafove databazi

Vytvor_profil("Patrik","Poklop","imang21","pokloppatrik@gmail.com",702742701,"patrik123",23,"H",["sport","posilovani"],"Ahoj já jsem Patrik")
